from PyQt5.QtWidgets import QApplication, QMainWindow, QDialog, QTableWidgetItem, QLabel, QFileDialog, QComboBox, \
    QSpinBox, QGraphicsPixmapItem, QGraphicsScene, QMessageBox
...
class Sale(QDialog):
    ...
    def show_izmen_sale(self):
        ...
        if sale_data:
            ...
            print("Данные о выбранной продаже не доступны.")
...
class IzmenTovar(QDialog):
    ...
    def save_changes(self):
        ...
        value7 = self.ui.lineEdit_6.text()
        value8 = self.ui.comboBox_2.currentText()
        print((image_path, int(value2), value3, value4, value5, int(value6), int(value7), value8,
               int(self.selected_tovar_articul)))
        ...
        try:
            ...
            cursor.execute("""
                ...
                WHERE Артикул = ?
            """, (image_path, int(value2), value3, value4, value5, int(value6), int(value7), value8,
                  int(self.selected_tovar_articul)))

            if not all([value2, value3, value4, value5, value6, value7, value7, image_path]):
                QMessageBox.warning(self, "Предупреждение", "Заполните все поля!")
                return
